...
df = yfinance.download(ticker, period="1mo", interval="5m")
print(df.shape)
...
plt.plot(data.shape[0]+12,prediction[0][0], marker="o", markersize=5, markeredgecolor="red", markerfacecolor="red")      #predicted price
plt.show()
